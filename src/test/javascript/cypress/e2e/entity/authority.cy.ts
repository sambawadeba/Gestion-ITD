...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '36fbcab2-717d-4d50-a11d-1b5127f03bc1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3e31e515-c475-49e5-a546-d2f435407dc7');
      cy.get(`[data-cy="name"]`).should('have.value', '3e31e515-c475-49e5-a546-d2f435407dc7');
